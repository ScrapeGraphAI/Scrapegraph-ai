...
class Generator:
    ...
    def __init__(
        ...
        Args:
            ...
            temperature_param (float): A parameter controlling the randomness of the language
            model's output.
            model_name (str): The name of the language model to be used (default: "gpt-3.5-turbo"). 
            All the possible models are available at the 
            following link: https://platform.openai.com/docs/models

        Returns:
            result_dict (dict): The result of the language model invocation, converted 
            to a dictionary.
        """
